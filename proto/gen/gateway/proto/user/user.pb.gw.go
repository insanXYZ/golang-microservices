...
func request_Users_Login_0(ctx context.Context, marshaler runtime.Marshaler, client user.UsersClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq user.UserLoginRequest
...
func local_request_Users_Login_0(ctx context.Context, marshaler runtime.Marshaler, server user.UsersServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq user.UserLoginRequest
		metadata runtime.ServerMetadata
	)
...
func RegisterUsersHandlerServer(ctx context.Context, mux *runtime.ServeMux, server user.UsersServer) error {
	mux.Handle(http.MethodPost, pattern_Users_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/User.Users/Login", runtime.WithHTTPPathPattern("/User.Users/Login"))
		if err != nil {
...
func RegisterUsersHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterUsersHandlerClient(ctx, mux, user.NewUsersClient(conn))
}
...
func RegisterUsersHandlerClient(ctx context.Context, mux *runtime.ServeMux, client user.UsersClient) error {
	mux.Handle(http.MethodPost, pattern_Users_Login_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/User.Users/Login", runtime.WithHTTPPathPattern("/User.Users/Login"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Users_Login_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"User.Users", "Login"}, ""))
)
